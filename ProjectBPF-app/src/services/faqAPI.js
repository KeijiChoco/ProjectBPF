...
const API_URL = "https://spfuxcghnwehwzejxieg.supabase.co/rest/v1/faq";
...
export const faqAPI = {
    ...
    async updateFaq(id, updateFaq) {
        const response = await axios.patch(`${API_URL}?id=eq.${id}`, updateFaq, { headers })
        return response.data
    }
}
